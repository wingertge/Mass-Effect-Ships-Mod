...
public class GuiOpenMachineBase<T extends ContainerMachineBase<? extends TileEntityMachineBase>> extends GuiAirshipsContainer<T> {
    public GuiOpenMachineBase(T container, String title) {
    ...
    public GuiOpenMachineBase(T container) {
